...
func (ctx *ServiceContext) OpenDatabase(name string, cache, handles int, namespace string) (ethdb.Database, error) {
...
func (ctx *ServiceContext) OpenDatabaseWithFreezer(name string, cache, handles int,
...
func (ctx *ServiceContext) Services() map[reflect.Type]Service {
	return ctx.services
}
