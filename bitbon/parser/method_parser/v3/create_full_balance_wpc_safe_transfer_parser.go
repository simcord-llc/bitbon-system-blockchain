...
func NewCreateFullBalanceWpcSafeTransferParser(ethApiWrapper interfaces.Contract, contractsSnapshot *storage_contract_snapshot.StorageContractSnapshot) *CreateFullBalanceWpcSafeTransferParser {
	p := &CreateFullBalanceWpcSafeTransferParser{
		CreateFullBalanceSafeTransferParser: NewCreateFullBalanceSafeTransferParser(ethApiWrapper, contractsSnapshot),
	}
	p.MethodId = dto.CreateFullBalanceWPCSafeTransferV3MethodId
