...
func CompileVyper(vyper string, sourcefiles ...string) (map[string]*Contract, error) {
	...
	args := s.makeArgs()
	cmd := exec.Command(s.Path, append(args, sourcefiles...)...) // nolint
...
func ParseVyperJSON(combinedJSON []byte, source, languageVersion, compilerVersion, compilerOptions string) (map[string]*Contract, error) {
