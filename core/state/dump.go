...
func (s *DB) dump(c collector, excludeCode, excludeStorage, excludeMissingPreimages bool, start []byte, maxResults int) (nextKey []byte) {
	missingPreimages := 0
...
func (s *DB) Dump(excludeCode, excludeStorage, excludeMissingPreimages bool) []byte {
	...
	marshalIndent, err := json.MarshalIndent(dump, "", "    ")
	if err != nil {
...
func (s *DB) IteratorDump(excludeCode, excludeStorage, excludeMissingPreimages bool, start []byte, maxResults int) IteratorDump {
