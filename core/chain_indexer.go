...
// nolint
func (c *ChainIndexer) proceedUpdateCh() {
	var (
		updating bool
		updated  time.Time
	)
...
// verifications.
func (c *ChainIndexer) Sections() (uint64, uint64, common.Hash) { // nolint
	c.lock.Lock()
	defer c.lock.Unlock()
...
func (c *ChainIndexer) setValidSections(sections uint64) {
	...
	c.indexDb.Put([]byte("count"), data[:]) // nolint:errcheck
...
func (c *ChainIndexer) setSectionHead(section uint64, hash common.Hash) {
	...
	c.indexDb.Put(append([]byte("shead"), data[:]...), hash.Bytes()) // nolint:errcheck
}
...
func (c *ChainIndexer) removeSectionHead(section uint64) {
	...
	c.indexDb.Delete(append([]byte("shead"), data[:]...)) // nolint:errcheck
}
