...
func Create(input []byte, cfg *Config) ([]byte, common.Address, uint64, error) { // nolint
	if cfg == nil {
		cfg = new(Config)
	}
	setDefaults(cfg)
...
// be set.
func Call(address common.Address, input []byte, cfg *Config) ([]byte, uint64, error) { //nolint
	setDefaults(cfg)
