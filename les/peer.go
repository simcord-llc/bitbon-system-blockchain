...
import (
	...
	"github.com/simcord-llc/bitbon-system-blockchain/les/flowcontrol"
	lpc "github.com/simcord-llc/bitbon-system-blockchain/les/lespay/client"
	"github.com/simcord-llc/bitbon-system-blockchain/les/utils"
	"github.com/simcord-llc/bitbon-system-blockchain/light"
...
type peerCommons struct {
	*p2p.Peer
	...
	announceType uint64    // nolint, New block announcement type.
	serving      uint32    // nolint, The status indicates the peer is served.
	...
	fcParams flowcontrol.ServerParams // nolint, The config for token bucket.
	fcCosts  requestCostTable         // nolint, The Maximum request cost table.
