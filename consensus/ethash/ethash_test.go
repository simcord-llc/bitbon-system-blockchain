...
// It reproduces https://github.com/simcord-llc/bitbon-system-blockchain/issues/14943
func TestCacheFileEvict(t *testing.T) {
	...
	e := New(Config{CachesInMem: 3, CachesOnDisk: 10, CacheDir: tmpdir, PowMode: ModeTest}, nil, false, nil)
	defer e.Close()
