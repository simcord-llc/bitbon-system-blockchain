...
type Backend interface {
	...
	StateAndHeaderByNumber(ctx context.Context, number rpc.BlockNumber) (*state.DB, *types.Header, error)
	StateAndHeaderByNumberOrHash(ctx context.Context, blockNrOrHash rpc.BlockNumberOrHash) (*state.DB, *types.Header, error)
