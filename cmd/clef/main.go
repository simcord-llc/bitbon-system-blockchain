...
import (
	...
	"github.com/simcord-llc/bitbon-system-blockchain/signer/core"
	"github.com/simcord-llc/bitbon-system-blockchain/signer/fourbyte"
	"github.com/simcord-llc/bitbon-system-blockchain/signer/rules"
...
var (
	...
	signerSecretFlag = cli.StringFlag{
		Name: "signersecret",
		Usage: "A file containing the (encrypted) master seed to encrypt Clef data, " +
			"e.g. keystore credentials and ruleset hash",
	}
