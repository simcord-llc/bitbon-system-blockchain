...
import "github.com/simcord-llc/bitbon-system-blockchain/accounts/abi"
...
{{range $contract := .Contracts}}
	...
	// Return Abi for {{$contract.Type}}Caller
	func (_{{$contract.Type}} *{{$contract.Type}}Caller) ABI() abi.ABI {
		return _{{$contract.Type}}.contract.Abi
	}
