...
import (
	...
	"github.com/simcord-llc/bitbon-system-blockchain/p2p/discover"
...
func (srv *Server) addProtocolSpecificDiscoverySources() {
	added := make(map[string]bool, len(srv.Protocols))
...
func (srv *Server) setupDiscovery() error {
	...
	srv.addProtocolSpecificDiscoverySources()
	...
	return srv.discovery(conn)
}

func (srv *Server) discovery(conn *net.UDPConn) error {
...
func (srv *Server) run() { // nolint:funlen,gocyclo
...
func (srv *Server) checkInboundConn(_ net.Conn, remoteIP net.IP) error {
	if remoteIP == nil {
		return nil
	}
