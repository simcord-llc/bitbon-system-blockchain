...
func unsetInternal(n node, left, right []byte) error {
...
func VerifyRangeProof(rootHash common.Hash, firstKey []byte, keys, values [][]byte, firstProof, lastProof ethdb.KeyValueReader) (error, bool) {
